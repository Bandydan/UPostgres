...
### 1. Створити таблицю з такими даними:
...
### 2. Відобразити дані наведеного нижче виду, звернути увагу на `he` та `she`:
...
### 3. Відобразити дані наведеного нижче виду:
...
### 4. Створити та заповнити структуру даних для зберігання словників та слів з них:
